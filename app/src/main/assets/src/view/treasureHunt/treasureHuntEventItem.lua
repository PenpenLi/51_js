local TreasureHuntEventItem=class("TreasureHuntEventItem",UILayer)

function TreasureHuntEventItem:ctor(eventWord, eventInfo)
    self:init("ui/ui_treasure_hunt_event_item.map")
...
function TreasureHuntEventItem:onTouchEnded(target,touch, event)
